...
func main() {
	...
	RootCmd.PersistentFlags().StringVarP(&TxFlags.HsmConfigFile, "hsmconfig", "", "", "hsm config file")
	RootCmd.PersistentFlags().StringVarP(&TxFlags.Algo, "algo", "", "ed25519", "crypto algo for the key- default is Ed25519 or Secp256k1")
