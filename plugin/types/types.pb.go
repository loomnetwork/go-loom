...
func (*GetCodeRequest) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{22} }

func (m *GetCodeRequest) GetContract() *types1.Address {
	if m != nil {
		return m.Contract
	}
	return nil
...
func (*GetCodeResponse) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{23} }

func (m *GetCodeResponse) GetBytecode() []byte {
	if m != nil {
		return m.Bytecode
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*GetCodeRequest)(nil), "GetCodeRequest")
	proto.RegisterType((*GetCodeResponse)(nil), "GetCodeResponse")
...
func (c *aPIClient) GetCode(ctx context.Context, in *GetCodeRequest, opts ...grpc.CallOption) (*GetCodeResponse, error) {
	out := new(GetCodeResponse)
	err := grpc.Invoke(ctx, "/API/GetCode", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _API_GetCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).GetCode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/API/GetCode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).GetCode(ctx, req.(*GetCodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptorTypes = []byte{
	...
	,
}
