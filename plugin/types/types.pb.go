...
func (m *EthBalanceRequest) Reset()                    { *m = EthBalanceRequest{} }
func (m *EthBalanceRequest) String() string            { return proto.CompactTextString(m) }
func (*EthBalanceRequest) ProtoMessage()               {}
func (*EthBalanceRequest) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{45} }

func (m *EthBalanceRequest) GetAddress() *types1.Address {
	if m != nil {
		return m.Address
	}
	return nil
...
type EthBalanceResponse struct {
	Balance *types1.BigUInt `protobuf:"bytes,1,opt,name=balance" json:"balance,omitempty"`
}

func (m *EthBalanceResponse) Reset()                    { *m = EthBalanceResponse{} }
func (m *EthBalanceResponse) String() string            { return proto.CompactTextString(m) }
func (*EthBalanceResponse) ProtoMessage()               {}
func (*EthBalanceResponse) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{46} }

func (m *EthBalanceResponse) GetBalance() *types1.BigUInt {
	if m != nil {
		return m.Balance
	}
	return nil
...
type TransferEthRequest struct {
	From   *types1.Address `protobuf:"bytes,1,opt,name=from" json:"from,omitempty"`
	To     *types1.Address `protobuf:"bytes,2,opt,name=to" json:"to,omitempty"`
	Amount *types1.BigUInt `protobuf:"bytes,3,opt,name=amount" json:"amount,omitempty"`
}

func (m *TransferEthRequest) Reset()                    { *m = TransferEthRequest{} }
func (m *TransferEthRequest) String() string            { return proto.CompactTextString(m) }
func (*TransferEthRequest) ProtoMessage()               {}
func (*TransferEthRequest) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{47} }

func (m *TransferEthRequest) GetFrom() *types1.Address {
	if m != nil {
		return m.From
	}
	return nil
...
func (m *TransferEthRequest) GetTo() *types1.Address {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *TransferEthRequest) GetAmount() *types1.BigUInt {
	if m != nil {
		return m.Amount
	}
	return nil
...
func (m *TransferEthResponse) Reset()                    { *m = TransferEthResponse{} }
func (m *TransferEthResponse) String() string            { return proto.CompactTextString(m) }
func (*TransferEthResponse) ProtoMessage()               {}
func (*TransferEthResponse) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{48} }
...
func init() {
	...
	proto.RegisterType((*EthBalanceRequest)(nil), "EthBalanceRequest")
	proto.RegisterType((*EthBalanceResponse)(nil), "EthBalanceResponse")
	proto.RegisterType((*TransferEthRequest)(nil), "TransferEthRequest")
	proto.RegisterType((*TransferEthResponse)(nil), "TransferEthResponse")
...
type APIClient interface {
	...
	EthBalanceOf(ctx context.Context, in *EthBalanceRequest, opts ...grpc.CallOption) (*EthBalanceResponse, error)
	TransferEth(ctx context.Context, in *TransferEthRequest, opts ...grpc.CallOption) (*TransferEthResponse, error)
}
...
func (c *aPIClient) EthBalanceOf(ctx context.Context, in *EthBalanceRequest, opts ...grpc.CallOption) (*EthBalanceResponse, error) {
	out := new(EthBalanceResponse)
	err := grpc.Invoke(ctx, "/API/EthBalanceOf", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) TransferEth(ctx context.Context, in *TransferEthRequest, opts ...grpc.CallOption) (*TransferEthResponse, error) {
	out := new(TransferEthResponse)
	err := grpc.Invoke(ctx, "/API/TransferEth", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServer interface {
	...
	EthBalanceOf(context.Context, *EthBalanceRequest) (*EthBalanceResponse, error)
	TransferEth(context.Context, *TransferEthRequest) (*TransferEthResponse, error)
}
...
func _API_EthBalanceOf_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EthBalanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).EthBalanceOf(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/API/EthBalanceOf",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).EthBalanceOf(ctx, req.(*EthBalanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _API_TransferEth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TransferEthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).TransferEth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/API/TransferEth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).TransferEth(ctx, req.(*TransferEthRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _API_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "EthBalanceOf",
			Handler:    _API_EthBalanceOf_Handler,
		},
		{
			MethodName: "TransferEth",
			Handler:    _API_TransferEth_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "github.com/loomnetwork/go-loom/plugin/types/types.proto",
...
var fileDescriptorTypes = []byte{
	...
	,
}
