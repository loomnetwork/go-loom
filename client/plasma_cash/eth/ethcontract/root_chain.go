...
//
// Solidity: function getPlasmaCoin(slot uint64) constant returns(uint64, uint256, uint32, address, uint8)
func (_RootChain *RootChainCaller) GetPlasmaCoin(opts *bind.CallOpts, slot uint64) (uint64, *big.Int, uint32, common.Address, uint8, error) {
	var (
		ret0 = new(uint64)
		ret1 = new(*big.Int)
		ret2 = new(uint32)
...
//
// Solidity: function getPlasmaCoin(slot uint64) constant returns(uint64, uint256, uint32, address, uint8)
func (_RootChain *RootChainSession) GetPlasmaCoin(slot uint64) (uint64, *big.Int, uint32, common.Address, uint8, error) {
...
//
// Solidity: function getPlasmaCoin(slot uint64) constant returns(uint64, uint256, uint32, address, uint8)
func (_RootChain *RootChainCallerSession) GetPlasmaCoin(slot uint64) (uint64, *big.Int, uint32, common.Address, uint8, error) {
	return _RootChain.Contract.GetPlasmaCoin(&_RootChain.CallOpts, slot)
}
...
// RespondChallengeBefore is a paid mutator transaction binding the contract method 0x4003567e.
//
// Solidity: function respondChallengeBefore(slot uint64, challengingBlockNumber uint256, challengingTransaction bytes, proof bytes, signature bytes) returns()
func (_RootChain *RootChainTransactor) RespondChallengeBefore(opts *bind.TransactOpts, slot uint64, challengingBlockNumber *big.Int, challengingTransaction []byte, proof []byte, signature []byte) (*types.Transaction, error) {
	return _RootChain.contract.Transact(opts, "respondChallengeBefore", slot, challengingBlockNumber, challengingTransaction, proof, signature)
}

// RespondChallengeBefore is a paid mutator transaction binding the contract method 0x4003567e.
//
// Solidity: function respondChallengeBefore(slot uint64, challengingBlockNumber uint256, challengingTransaction bytes, proof bytes, signature bytes) returns()
func (_RootChain *RootChainSession) RespondChallengeBefore(slot uint64, challengingBlockNumber *big.Int, challengingTransaction []byte, proof []byte, signature []byte) (*types.Transaction, error) {
	return _RootChain.Contract.RespondChallengeBefore(&_RootChain.TransactOpts, slot, challengingBlockNumber, challengingTransaction, proof, signature)
}

// RespondChallengeBefore is a paid mutator transaction binding the contract method 0x4003567e.
//
// Solidity: function respondChallengeBefore(slot uint64, challengingBlockNumber uint256, challengingTransaction bytes, proof bytes, signature bytes) returns()
func (_RootChain *RootChainTransactorSession) RespondChallengeBefore(slot uint64, challengingBlockNumber *big.Int, challengingTransaction []byte, proof []byte, signature []byte) (*types.Transaction, error) {
	return _RootChain.Contract.RespondChallengeBefore(&_RootChain.TransactOpts, slot, challengingBlockNumber, challengingTransaction, proof, signature)
}
...
//
// Solidity: e Deposit(slot indexed uint64, blockNumber uint256, denomination uint64, from indexed address)
