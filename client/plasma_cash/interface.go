...
type ChainServiceClient interface {
	...
	SendTransaction(slot uint64, prevBlock *big.Int, denomination *big.Int, newOwner string, prevOwner string, sig []byte, hash []byte, replayProtectionSignature []byte) error
}
