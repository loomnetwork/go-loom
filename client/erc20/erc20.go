...
func (_ERC20 *ERC20Caller) IsGateway(opts *bind.CallOpts, gateway common.Address) (bool, error) {
	...
	out := ret0
	err := _ERC20.contract.Call(opts, out, "isGateway", gateway)
	return *ret0, err
}
...
func (_ERC20 *ERC20Session) IsGateway(gateway common.Address) (bool, error) {
	return _ERC20.Contract.IsGateway(&_ERC20.CallOpts, gateway)
}
...
func (_ERC20 *ERC20Caller) IsValidator(opts *bind.CallOpts, validator common.Address) (bool, error) {
	...
	out := ret0
	err := _ERC20.contract.Call(opts, out, "isValidator", validator)
	return *ret0, err
}
...
func (_ERC20 *ERC20Session) IsValidator(validator common.Address) (bool, error) {
	return _ERC20.Contract.IsValidator(&_ERC20.CallOpts, validator)
}
...
func (_ERC20 *ERC20Transactor) AddValidator(opts *bind.TransactOpts, newValidator common.Address) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "addValidator", newValidator)
}
...
func (_ERC20 *ERC20Session) AddValidator(newValidator common.Address) (*types.Transaction, error) {
	return _ERC20.Contract.AddValidator(&_ERC20.TransactOpts, newValidator)
}
...
func (_ERC20 *ERC20Transactor) MintTo(opts *bind.TransactOpts, _to common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "mintTo", _to, _amount)
}
...
func (_ERC20 *ERC20Session) MintTo(_to common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _ERC20.Contract.MintTo(&_ERC20.TransactOpts, _to, _amount)
}
...
func (_ERC20 *ERC20Transactor) RemoveGateway(opts *bind.TransactOpts, _gateway common.Address) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "removeGateway", _gateway)
}
...
func (_ERC20 *ERC20Session) RemoveGateway(_gateway common.Address) (*types.Transaction, error) {
	return _ERC20.Contract.RemoveGateway(&_ERC20.TransactOpts, _gateway)
}
...
func (_ERC20 *ERC20Transactor) RemoveValidator(opts *bind.TransactOpts, validator common.Address) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "removeValidator", validator)
}
...
func (_ERC20 *ERC20Session) RemoveValidator(validator common.Address) (*types.Transaction, error) {
	return _ERC20.Contract.RemoveValidator(&_ERC20.TransactOpts, validator)
}
...
type ERC20GatewayAddedIterator struct {
	Event *ERC20GatewayAdded // Event containing the contract specifics and raw log
...
func (it *ERC20GatewayAddedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ERC20GatewayAdded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (_ERC20 *ERC20Filterer) FilterGatewayAdded(opts *bind.FilterOpts) (*ERC20GatewayAddedIterator, error) {
	...
	logs, sub, err := _ERC20.contract.FilterLogs(opts, "GatewayAdded")
	if err != nil {
		return nil, err
	}
	return &ERC20GatewayAddedIterator{contract: _ERC20.contract, event: "GatewayAdded", logs: logs, sub: sub}, nil
}
...
func (_ERC20 *ERC20Filterer) WatchGatewayAdded(opts *bind.WatchOpts, sink chan<- *ERC20GatewayAdded) (event.Subscription, error) {
	...
	logs, sub, err := _ERC20.contract.WatchLogs(opts, "GatewayAdded")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC20GatewayAdded)
				if err := _ERC20.contract.UnpackLog(event, "GatewayAdded", log); err != nil {
					return err
				}
				event.Raw = log
...
type ERC20GatewayRemovedIterator struct {
	Event *ERC20GatewayRemoved // Event containing the contract specifics and raw log
...
func (it *ERC20GatewayRemovedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ERC20GatewayRemoved)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type ERC20GatewayRemoved struct {
	Gateway common.Address
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_ERC20 *ERC20Filterer) FilterGatewayRemoved(opts *bind.FilterOpts) (*ERC20GatewayRemovedIterator, error) {
	...
	logs, sub, err := _ERC20.contract.FilterLogs(opts, "GatewayRemoved")
	if err != nil {
		return nil, err
	}
	return &ERC20GatewayRemovedIterator{contract: _ERC20.contract, event: "GatewayRemoved", logs: logs, sub: sub}, nil
}
...
func (_ERC20 *ERC20Filterer) WatchGatewayRemoved(opts *bind.WatchOpts, sink chan<- *ERC20GatewayRemoved) (event.Subscription, error) {
	...
	logs, sub, err := _ERC20.contract.WatchLogs(opts, "GatewayRemoved")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC20GatewayRemoved)
				if err := _ERC20.contract.UnpackLog(event, "GatewayRemoved", log); err != nil {
					return err
				}
				event.Raw = log
...
type ERC20ValidatorAddedIterator struct {
	Event *ERC20ValidatorAdded // Event containing the contract specifics and raw log
...
func (it *ERC20ValidatorAddedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ERC20ValidatorAdded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type ERC20ValidatorAdded struct {
...
func (_ERC20 *ERC20Filterer) FilterValidatorAdded(opts *bind.FilterOpts) (*ERC20ValidatorAddedIterator, error) {
	...
	logs, sub, err := _ERC20.contract.FilterLogs(opts, "ValidatorAdded")
	if err != nil {
		return nil, err
	}
	return &ERC20ValidatorAddedIterator{contract: _ERC20.contract, event: "ValidatorAdded", logs: logs, sub: sub}, nil
}
...
func (_ERC20 *ERC20Filterer) WatchValidatorAdded(opts *bind.WatchOpts, sink chan<- *ERC20ValidatorAdded) (event.Subscription, error) {
	...
	logs, sub, err := _ERC20.contract.WatchLogs(opts, "ValidatorAdded")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC20ValidatorAdded)
				if err := _ERC20.contract.UnpackLog(event, "ValidatorAdded", log); err != nil {
					return err
				}
				event.Raw = log
...
type ERC20ValidatorRemovedIterator struct {
	Event *ERC20ValidatorRemoved // Event containing the contract specifics and raw log
...
func (it *ERC20ValidatorRemovedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ERC20ValidatorRemoved)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type ERC20ValidatorRemoved struct {
	Validator common.Address
	Raw       types.Log // Blockchain specific contextual infos
}
...
func (_ERC20 *ERC20Filterer) FilterValidatorRemoved(opts *bind.FilterOpts) (*ERC20ValidatorRemovedIterator, error) {
	...
	logs, sub, err := _ERC20.contract.FilterLogs(opts, "ValidatorRemoved")
	if err != nil {
		return nil, err
	}
	return &ERC20ValidatorRemovedIterator{contract: _ERC20.contract, event: "ValidatorRemoved", logs: logs, sub: sub}, nil
}
...
func (_ERC20 *ERC20Filterer) WatchValidatorRemoved(opts *bind.WatchOpts, sink chan<- *ERC20ValidatorRemoved) (event.Subscription, error) {
	...
	logs, sub, err := _ERC20.contract.WatchLogs(opts, "ValidatorRemoved")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC20ValidatorRemoved)
				if err := _ERC20.contract.UnpackLog(event, "ValidatorRemoved", log); err != nil {
					return err
				}
				event.Raw = log
