...
func (*AddressMapperMapping) Descriptor() ([]byte, []int) {
	return fileDescriptor_address_mapper_31a3b43045759d79, []int{0}
}
...
func (*AddressMapperInitRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_address_mapper_31a3b43045759d79, []int{1}
}
...
func (*AddressMapperAddIdentityMappingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_address_mapper_31a3b43045759d79, []int{2}
}
...
func (*AddressMapperRemoveMappingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_address_mapper_31a3b43045759d79, []int{3}
}
...
func (*AddressMapperGetMappingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_address_mapper_31a3b43045759d79, []int{4}
}
...
func (*AddressMapperGetMappingResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_address_mapper_31a3b43045759d79, []int{5}
}
...
func (*AddressMapperHasMappingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_address_mapper_31a3b43045759d79, []int{6}
}
...
func (*AddressMapperHasMappingResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_address_mapper_31a3b43045759d79, []int{7}
}
...
func init() {
	proto.RegisterFile("github.com/loomnetwork/go-loom/builtin/types/address_mapper/address_mapper.proto", fileDescriptor_address_mapper_31a3b43045759d79)
}

var fileDescriptor_address_mapper_31a3b43045759d79 = []byte{
