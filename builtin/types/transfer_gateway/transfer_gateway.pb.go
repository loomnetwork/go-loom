...
func (TransferGatewayTokenKind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{0}
}
...
type TransferGatewayState struct {
	...
	// Last Tron block processed by the Transfer Gateway contract
	LastTronBlockNum     uint64   `protobuf:"varint,5,opt,name=last_tron_block_num,json=lastTronBlockNum,proto3" json:"last_tron_block_num,omitempty"`
...
func (m *TransferGatewayState) GetLastTronBlockNum() uint64 {
	if m != nil {
		return m.LastTronBlockNum
	}
	return 0
}
...
func (*TransferGatewayOracleState) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{1}
}
...
func (*TransferGatewayWithdrawalReceipt) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{2}
}
...
func (*TransferGatewayPendingWithdrawalSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{3}
}
...
func (*TransferGatewayLocalAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{4}
}
...
func (*TransferGatewayForeignAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{5}
}
...
func (*TransferGatewayTokenAmount) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{6}
}
...
func (*TransferGatewayUnclaimedToken) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{7}
}
...
func (*TransferGatewayTokenDeposited) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{8}
}
...
func (*TransferGatewayTokenWithdrawn) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{9}
}
...
func (*TransferGatewayMainnetEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{10}
}
...
type TransferGatewayTronEvent struct {
	TronBlock uint64 `protobuf:"varint,1,opt,name=tron_block,json=tronBlock,proto3" json:"tron_block,omitempty"`
	// Types that are valid to be assigned to Payload:
	//	*TransferGatewayTronEvent_Deposit
	//	*TransferGatewayTronEvent_Withdrawal
	Payload              isTransferGatewayTronEvent_Payload `protobuf_oneof:"payload"`
	XXX_NoUnkeyedLiteral struct{}                           `json:"-"`
	XXX_unrecognized     []byte                             `json:"-"`
	XXX_sizecache        int32                              `json:"-"`
}

func (m *TransferGatewayTronEvent) Reset()         { *m = TransferGatewayTronEvent{} }
func (m *TransferGatewayTronEvent) String() string { return proto.CompactTextString(m) }
func (*TransferGatewayTronEvent) ProtoMessage()    {}
func (*TransferGatewayTronEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{11}
}
func (m *TransferGatewayTronEvent) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TransferGatewayTronEvent.Unmarshal(m, b)
}
func (m *TransferGatewayTronEvent) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TransferGatewayTronEvent.Marshal(b, m, deterministic)
}
func (dst *TransferGatewayTronEvent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TransferGatewayTronEvent.Merge(dst, src)
}
func (m *TransferGatewayTronEvent) XXX_Size() int {
	return xxx_messageInfo_TransferGatewayTronEvent.Size(m)
}
func (m *TransferGatewayTronEvent) XXX_DiscardUnknown() {
	xxx_messageInfo_TransferGatewayTronEvent.DiscardUnknown(m)
}

var xxx_messageInfo_TransferGatewayTronEvent proto.InternalMessageInfo

type isTransferGatewayTronEvent_Payload interface {
	isTransferGatewayTronEvent_Payload()
}

type TransferGatewayTronEvent_Deposit struct {
	Deposit *TransferGatewayTokenDeposited `protobuf:"bytes,2,opt,name=deposit,oneof"`
}
type TransferGatewayTronEvent_Withdrawal struct {
	Withdrawal *TransferGatewayTokenWithdrawn `protobuf:"bytes,3,opt,name=withdrawal,oneof"`
}

func (*TransferGatewayTronEvent_Deposit) isTransferGatewayTronEvent_Payload()    {}
func (*TransferGatewayTronEvent_Withdrawal) isTransferGatewayTronEvent_Payload() {}

func (m *TransferGatewayTronEvent) GetPayload() isTransferGatewayTronEvent_Payload {
	if m != nil {
		return m.Payload
	}
	return nil
...
func (m *TransferGatewayTronEvent) GetTronBlock() uint64 {
	if m != nil {
		return m.TronBlock
	}
	return 0
...
func (m *TransferGatewayTronEvent) GetDeposit() *TransferGatewayTokenDeposited {
	if x, ok := m.GetPayload().(*TransferGatewayTronEvent_Deposit); ok {
		return x.Deposit
	}
	return nil
}

func (m *TransferGatewayTronEvent) GetWithdrawal() *TransferGatewayTokenWithdrawn {
	if x, ok := m.GetPayload().(*TransferGatewayTronEvent_Withdrawal); ok {
		return x.Withdrawal
	}
	return nil
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*TransferGatewayTronEvent) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _TransferGatewayTronEvent_OneofMarshaler, _TransferGatewayTronEvent_OneofUnmarshaler, _TransferGatewayTronEvent_OneofSizer, []interface{}{
		(*TransferGatewayTronEvent_Deposit)(nil),
		(*TransferGatewayTronEvent_Withdrawal)(nil),
	}
}

func _TransferGatewayTronEvent_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*TransferGatewayTronEvent)
	// payload
	switch x := m.Payload.(type) {
	case *TransferGatewayTronEvent_Deposit:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Deposit); err != nil {
			return err
		}
	case *TransferGatewayTronEvent_Withdrawal:
		_ = b.EncodeVarint(3<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Withdrawal); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("TransferGatewayTronEvent.Payload has unexpected type %T", x)
	}
	return nil
}

func _TransferGatewayTronEvent_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*TransferGatewayTronEvent)
	switch tag {
	case 2: // payload.deposit
		if wire != proto.WireBytes {
		...
		msg := new(TransferGatewayTokenDeposited)
		err := b.DecodeMessage(msg)
		m.Payload = &TransferGatewayTronEvent_Deposit{msg}
		return true, err
	case 3: // payload.withdrawal
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		...
		msg := new(TransferGatewayTokenWithdrawn)
		err := b.DecodeMessage(msg)
		m.Payload = &TransferGatewayTronEvent_Withdrawal{msg}
		return true, err
	default:
		return false, nil
	}
...
func _TransferGatewayTronEvent_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*TransferGatewayTronEvent)
	// payload
	switch x := m.Payload.(type) {
	case *TransferGatewayTronEvent_Deposit:
...
func (*TransferGatewayPendingContractMapping) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{12}
}
...
func (*TransferGatewayContractAddressMapping) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{13}
}
...
func (*TransferGatewayUnverifiedContractCreator) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{14}
}
...
func (*TransferGatewayVerifiedContractCreator) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{15}
}
...
func (*TransferGatewayContractMappingConfirmed) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{16}
}
...
func (*TransferGatewayTokenWithdrawalSigned) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{17}
}
...
func (*TransferGatewayInitRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{18}
}
...
func (*TransferGatewayAddOracleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{19}
}
...
func (*TransferGatewayRemoveOracleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{20}
}
...
func (*TransferGatewayGetOraclesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{21}
}
...
func (*TransferGatewayGetOraclesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{22}
}
...
func (*TransferGatewayAddContractMappingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{23}
}
...
func (*TransferGatewayUnverifiedContractCreatorsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{24}
}
...
func (*TransferGatewayUnverifiedContractCreatorsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{25}
}
...
func (*TransferGatewayVerifyContractCreatorsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{26}
}
...
func (*TransferGatewayProcessEventBatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{27}
}
...
func (*TransferGatewayStateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{28}
}
...
func (*TransferGatewayStateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{29}
}
...
// Batch of events from the Gateway on Tron
type TransferGatewayProcessTronEventBatchRequest struct {
	Events               []*TransferGatewayTronEvent `protobuf:"bytes,1,rep,name=events" json:"events,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}

func (m *TransferGatewayProcessTronEventBatchRequest) Reset() {
	*m = TransferGatewayProcessTronEventBatchRequest{}
}
func (m *TransferGatewayProcessTronEventBatchRequest) String() string {
	return proto.CompactTextString(m)
}
func (*TransferGatewayProcessTronEventBatchRequest) ProtoMessage() {}
func (*TransferGatewayProcessTronEventBatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{30}
}
func (m *TransferGatewayProcessTronEventBatchRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TransferGatewayProcessTronEventBatchRequest.Unmarshal(m, b)
}
func (m *TransferGatewayProcessTronEventBatchRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TransferGatewayProcessTronEventBatchRequest.Marshal(b, m, deterministic)
}
func (dst *TransferGatewayProcessTronEventBatchRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TransferGatewayProcessTronEventBatchRequest.Merge(dst, src)
}
func (m *TransferGatewayProcessTronEventBatchRequest) XXX_Size() int {
	return xxx_messageInfo_TransferGatewayProcessTronEventBatchRequest.Size(m)
}
func (m *TransferGatewayProcessTronEventBatchRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_TransferGatewayProcessTronEventBatchRequest.DiscardUnknown(m)
}

var xxx_messageInfo_TransferGatewayProcessTronEventBatchRequest proto.InternalMessageInfo

func (m *TransferGatewayProcessTronEventBatchRequest) GetEvents() []*TransferGatewayTronEvent {
	if m != nil {
		return m.Events
	}
	return nil
...
func (*TransferGatewayReclaimDepositorTokensRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{31}
}
...
func (*TransferGatewayReclaimContractTokensRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{32}
}
...
func (*TransferGatewayWithdrawTokenRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{33}
}
...
func (*TransferGatewayWithdrawLoomCoinRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{34}
}
...
func (*TransferGatewayWithdrawETHRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{35}
}
...
func (*TransferGatewayWithdrawalReceiptRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{36}
}
...
func (*TransferGatewayWithdrawalReceiptResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{37}
}
...
func (*TransferGatewayConfirmWithdrawalReceiptRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{38}
}
...
func (*TransferGatewayPendingWithdrawalsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{39}
}
...
func (*TransferGatewayPendingWithdrawalsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{40}
}
...
func (*TransferGatewayResetMainnetBlockRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{41}
}
...
func (*TransferGatewayProcessMainnetEventError) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{42}
}
...
type TransferGatewayProcessTronEventError struct {
	TronBlock            uint64                    `protobuf:"varint,1,opt,name=tron_block,json=tronBlock,proto3" json:"tron_block,omitempty"`
	Event                *TransferGatewayTronEvent `protobuf:"bytes,2,opt,name=event" json:"event,omitempty"`
	ErrorMessage         string                    `protobuf:"bytes,3,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
...
func (m *TransferGatewayProcessTronEventError) Reset()         { *m = TransferGatewayProcessTronEventError{} }
func (m *TransferGatewayProcessTronEventError) String() string { return proto.CompactTextString(m) }
func (*TransferGatewayProcessTronEventError) ProtoMessage()    {}
func (*TransferGatewayProcessTronEventError) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{43}
}
func (m *TransferGatewayProcessTronEventError) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TransferGatewayProcessTronEventError.Unmarshal(m, b)
}
func (m *TransferGatewayProcessTronEventError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TransferGatewayProcessTronEventError.Marshal(b, m, deterministic)
}
func (dst *TransferGatewayProcessTronEventError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TransferGatewayProcessTronEventError.Merge(dst, src)
}
func (m *TransferGatewayProcessTronEventError) XXX_Size() int {
	return xxx_messageInfo_TransferGatewayProcessTronEventError.Size(m)
}
func (m *TransferGatewayProcessTronEventError) XXX_DiscardUnknown() {
	xxx_messageInfo_TransferGatewayProcessTronEventError.DiscardUnknown(m)
}

var xxx_messageInfo_TransferGatewayProcessTronEventError proto.InternalMessageInfo

func (m *TransferGatewayProcessTronEventError) GetTronBlock() uint64 {
	if m != nil {
		return m.TronBlock
	}
	return 0
...
func (m *TransferGatewayProcessTronEventError) GetEvent() *TransferGatewayTronEvent {
	if m != nil {
		return m.Event
	}
	return nil
...
func (m *TransferGatewayProcessTronEventError) GetErrorMessage() string {
	if m != nil {
		return m.ErrorMessage
	}
	return ""
...
func (*TransferGatewayReclaimError) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{44}
}
...
func (*TransferGatewayWithdrawETHError) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{45}
}
...
func (*TransferGatewayWithdrawLoomCoinError) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{46}
}
...
func (*TransferGatewayWithdrawTokenError) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{47}
}
...
func (*TransferGatewayGetUnclaimedTokensRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{48}
}
...
func (*TransferGatewayGetUnclaimedTokensResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{49}
}
...
func (*TransferGatewayMainnetEventTxHashInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d, []int{50}
}
...
func init() {
	...
	proto.RegisterType((*TransferGatewayTronEvent)(nil), "TransferGatewayTronEvent")
	...
	proto.RegisterType((*TransferGatewayProcessTronEventBatchRequest)(nil), "TransferGatewayProcessTronEventBatchRequest")
	...
	proto.RegisterType((*TransferGatewayProcessTronEventError)(nil), "TransferGatewayProcessTronEventError")
...
func init() {
	proto.RegisterFile("github.com/loomnetwork/go-loom/builtin/types/transfer_gateway/transfer_gateway.proto", fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d)
}

var fileDescriptor_transfer_gateway_e0a1e0861fd6aa8d = []byte{
	...
	,
}
